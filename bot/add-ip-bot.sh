#!/bin/bash
# // PROJECT STORE
url_izin="https://raw.githubusercontent.com/denisa32/permission/main/ip"
...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mWhatsapp${NC} wa.me/628388886316"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
checking_sc
# Token denisa32 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
TOKEN="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"
today=`date -d "0 days" +"%Y-%m-%d"`
git clone https://github.com/denisa32/permission.git /root/ipvps/ &> /dev/null
clear
echo -e ""
...
cd /root/ipvps
git config --global user.email "ellasusilo@gmail.com" &> /dev/null
...
git remote add origin https://github.com/denisa32/permission
